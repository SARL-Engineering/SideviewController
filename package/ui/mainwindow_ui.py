...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pbCamRefresh = QtGui.QPushButton(self.tabCam)
        self.pbCamRefresh.setMaximumSize(QtCore.QSize(200, 30))
        self.pbCamRefresh.setObjectName(_fromUtf8("pbCamRefresh"))
        self.vlCam.addWidget(self.pbCamRefresh)
        ...
        self.tabCom.setObjectName(_fromUtf8("tabCom"))
        self.horizontalLayout_6 = QtGui.QHBoxLayout(self.tabCom)
        self.horizontalLayout_6.setObjectName(_fromUtf8("horizontalLayout_6"))
        self.hlTabCOM = QtGui.QHBoxLayout()
        self.hlTabCOM.setObjectName(_fromUtf8("hlTabCOM"))
        self.lwCOM = QtGui.QListWidget(self.tabCom)
        self.lwCOM.setObjectName(_fromUtf8("lwCOM"))
        self.hlTabCOM.addWidget(self.lwCOM)
        self.vlCOM = QtGui.QVBoxLayout()
        self.vlCOM.setObjectName(_fromUtf8("vlCOM"))
        self.pbCOMAdd = QtGui.QPushButton(self.tabCom)
        self.pbCOMAdd.setMaximumSize(QtCore.QSize(200, 30))
        self.pbCOMAdd.setObjectName(_fromUtf8("pbCOMAdd"))
        self.vlCOM.addWidget(self.pbCOMAdd)
        self.pbCOMEdit = QtGui.QPushButton(self.tabCom)
        self.pbCOMEdit.setMaximumSize(QtCore.QSize(200, 30))
        self.pbCOMEdit.setObjectName(_fromUtf8("pbCOMEdit"))
        self.vlCOM.addWidget(self.pbCOMEdit)
        self.pbCOMOpen = QtGui.QPushButton(self.tabCom)
        self.pbCOMOpen.setMaximumSize(QtCore.QSize(200, 30))
        self.pbCOMOpen.setObjectName(_fromUtf8("pbCOMOpen"))
        self.vlCOM.addWidget(self.pbCOMOpen)
        self.pbCOMRemove = QtGui.QPushButton(self.tabCom)
        self.pbCOMRemove.setMaximumSize(QtCore.QSize(200, 30))
        self.pbCOMRemove.setObjectName(_fromUtf8("pbCOMRemove"))
        self.vlCOM.addWidget(self.pbCOMRemove)
        spacerItem2 = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.vlCOM.addItem(spacerItem2)
        self.hlTabCOM.addLayout(self.vlCOM)
        self.hlTabCOM.setStretch(0, 4)
        self.hlTabCOM.setStretch(1, 1)
        self.horizontalLayout_6.addLayout(self.hlTabCOM)
        self.tabGroup.addTab(self.tabCom, _fromUtf8(""))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pbCamRefresh.setText(_translate("MainWindow", "PushButton", None))
        ...
        self.pbCOMAdd.setText(_translate("MainWindow", "PushButton", None))
        self.pbCOMEdit.setText(_translate("MainWindow", "PushButton", None))
        self.pbCOMOpen.setText(_translate("MainWindow", "PushButton", None))
        self.pbCOMRemove.setText(_translate("MainWindow", "PushButton", None))
        self.tabGroup.setTabText(self.tabGroup.indexOf(self.tabCom), _translate("MainWindow", "Tab 1", None))
